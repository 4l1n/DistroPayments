...
/* WEBPACK VAR INJECTION */(function($) {$(document).on("turbolinks:load", function () {
  ...
  function moveBackground() {
    ...
    y += (lFollowY - y) * friction; //  translate = 'translateX(' + x + 'px, ' + y + 'px)';
  ...
  $(window).on('mousemove', function (e) {
    var isHovered = $('.animate-this:hover').length > 0; //if(!$(e.target).hasClass('animate-this')) {
...
/******/ });
//# sourceMappingURL=application-821c4f022854f68d43ae.js.map